...
export function FortuneEditor({
  ...
  const handleDeleteFortune = () => {
    ...
    onFortunesChange(fortunes.filter((fortune) => fortune.id !== pendingDeleteId))
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="h-[92svh] max-w-[96vw] p-0 sm:max-w-[96vw]">
                ...
                <tr key={fortune.id} className="border-b align-top">
                  ...
                  <td className="w-10 px-2 py-2">
                    <Button
                      variant="destructive"
                      size="icon"
                      onClick={() => setPendingDeleteId(fortune.id)}
        ...
        <div className="border-t px-4 py-3">
          <Button onClick={handleAddFortune}>Add Fortune</Button>
        </div>
      </DialogContent>
    </Dialog>
    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to delete this fortune? This action cannot be
            undone.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
